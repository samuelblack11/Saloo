...
struct PreSetCalendarDates {
    ...
    init(eventList: [String: Date]) {
        ...
        self.eventList["MLK Day ✊🏿"] = createDate(eventDate: "01/17/2022")
        ...
        self.eventList["Ash Wednesday ⛪️"] = createDate(eventDate: "03/02/2022")
        ...
        self.eventList["Eid al-Fitr ☪️"] = createDate(eventDate: "04/21/2022")
