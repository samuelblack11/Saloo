...
struct GreetMe_2App: App {
    ...
    var body: some Scene {
        WindowGroup {
            OccassionsMenu(searchType: $string1, occassion: $string1, collectionID: $string1, noneSearch: $string2, calViewModel: CalViewModel(), showDetailView: ShowDetailView(), oo2: false)
